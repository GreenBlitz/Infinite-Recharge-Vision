...
REMOTE_THRESHOLD = gbv.ColorThreshold([[20, 100], [54, 134], [207, 255]], 'HLS') + gbv.MedianBlur(5) + gbv.Dilate(2)
...
def main():
    ...
    window = gbv.StreamWindow(window_name='stream', wrap_object=receiver,
                              drawing_pipeline=gbv.DrawCircles(REMOTE_THRESHOLD, (0, 255, 0), circle_process=gbv.sort_circles + gbv.filter_inner_circles, thickness=5))
    window.show_async()
